...
describe('Test Suite', function () {
  ...
  var UG = require('../module.js');

  var Unit = require('../lib/unit/unit.js');
  var Node = require('../lib/unit/node.js');
  var Edge = require('../lib/unit/edge.js');

  var Collection = require('../lib/collection/collection.js');
  var NodeCollection = require('../lib/collection/node_collection.js');
  var EdgeCollection = require('../lib/collection/edge_collection.js');
  ...
  describe('UnitGraph', function () {
    ...
    describe('Collections', function () {
      ...
      var nc = graph.nodes('testNode');
      var ec = graph.edges('testEdge');
    ...
    describe('Units', function () {
      ...
      var n = graph._nodes[0];
      var n2 = graph._nodes[1];
      var e = graph._edges[0];
    ...
    describe('Traversal', function () {
      ...
      describe('Graph#trace', function () {
        ...
        var nodes = [graph.nodes('person').find(1), graph.nodes('food').find(4), graph.nodes('person').find(5), graph.nodes('food').find(2), graph.nodes('person').find(3)];

        var path = graph.trace(graph.nodes('person').find(1), graph.nodes('person').find(3));
      ...
      describe('Graph#closest', function () {
        ...
        var paths = graph.closest(graph.nodes('person').find(2), {
        ...
        it('should have the nodes adjacent to 1st adjacent node as the next entries (any order)', function () {
          ...
          var cnodes = [graph.nodes('person').find(1), graph.nodes('person').find(4)];
